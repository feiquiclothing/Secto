...
try {
  return JSON.parse(
    localStorage.getItem("secto_print_order") ||
      sessionStorage.getItem("secto_print_order") ||
      "null"
  );
} catch {
  return null;
...
const isWhatsApp =
order?.source === "whatsapp" || !!order?.rawText;
...
return ( <div className="t"> <div className="c"> <div className="b">SECTO CAFE</div> <div className="m">Piedras 276</div> </div>
