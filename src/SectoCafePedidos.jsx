...
const MENU = [
  {
    ...
    items: [
      ...
      { id: "r04", name: "Philadelphia Hot Roll - Boniato | Palta | Queso | Sésamo | Frito en panko | Taré | Verdeo", price: 380, img: "/hotroll.jpg" },
      ...
      { id: "r10", name: "Teriyaki Roll - Boniato tempura | Mango | Quinoa frita | Verdeo | Teriyaki", price: 380, img: "/Photos/teriy.jpg" },
    ],
  },
  {
    id: "combos",
    ...
    items: [
      ...
      { id: "c03", name: "Combo 40 piezas", price: 1280 },
      { id: "c04", name: "Combo 50 piezas", price: 1640 },
    ],
  },
  {
    id: "extras",
