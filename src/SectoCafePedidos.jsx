...
function PokeBuilder({ onAdd, isOpen }) {
  ...
  const canAdd = Boolean(base) && Boolean(protein) && Boolean(sauce) && toppings.length >= 3;
            ...
            <div className="grid grid-cols-1 gap-2 mt-4">
              ...
              {!isOpen && (
                <p className="text-xs text-red-600 mt-1">
                  Cerrado — pedidos habilitados viernes y sábado de{" "}
                  {OPEN_HOUR_START}:00 a{" "}
