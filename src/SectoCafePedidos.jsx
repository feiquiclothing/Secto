 ...
 * - Paleta: negros y grises (neutral-900..400), tipografía sobria, mucho aire.
 * - Layout en columnas con espacio para fotos (masonry) + catálogo + checkout.
 * - WhatsApp listo y hook para Mercado Pago (endpoint opcional MP_ENDPOINT).
 */

// =============== CONFIG ===============
const PHONE_URUGUAY = "091388682"; // WhatsApp destino
const MP_ENDPOINT = ""; // Opcional: Apps Script de MP. Si está vacío, ocultamos el botón MP.

// Galería de fotos (pueden ser URLs absolutas o /images/*.jpg en tu repo)
const GALLERY = [
  "/photos/secto_01.jpg",
  "/photos/secto_02.jpg",
  "/photos/secto_03.jpg",
...
// Menú (podés sumar campo img por ítem)
const MENU = [
  {
    id: "rolls",
    name: "ROLLS (8u)",
    items: [
      { id: "r01", name: "Tomate seco / Ciboulette / Phila", price: 320, img: "/photos/roll_01.jpg" },
      { id: "r02", name: "Salmón / Phila / Mango / Quinoa frita", price: 520, img: "/photos/roll_02.jpg" },
      { id: "r03", name: "Atún / Mango / Pepino / Sésamo / Crema palta / Cilantro", price: 480 },
      ...
      { id: "r09", name: "Hongos / Cebolla caramelizada / Rúcula / Phila", price: 430 },
    ],
  },
  {
    id: "geishas",
