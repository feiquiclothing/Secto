...
const MENU = [
  {
    ...
    items: [
      { id: "r01", name: "Mango Roll - Mango | Palta | Pepino | Sésamo | Mayo wasabi", price: 380, img: "/Photos/mango.jpg" },
      { id: "r02", name: "Green Roll - Palta | Pepino | Rúcula | Queso | Sésamo", price: 380, img: "/Photos/green.jpg" },
      ...
      { id: "r05", name: "Sweet Crunch - Boniato | Mango | Queso | Quinoa frita | Batayaki | Boniato frito", price: 420, img: "/Photos/sweet.jpg" },
      { id: "r06", name: "Tempura Veggie - Zucchini tempura | Palta | Queso | Sésamo | Verdeo", price: 380, img: "/Photos/tempura.jpg" },
      { id: "r07", name: "Spicy carrot - Boniato | Palta | Queso | Spicy carrot | Verdeo", price: 420, img: "/Photos/spicy.jpg" },
      ...
      { id: "r10", name: "Teriyaki Roll - Boniato tempura | Mango | Quinoa frita | Verdeo | Teriyaki", price: 380, img: "/Photos/teri.jpg" },
    ],
  },
  {
    id: "combos",
    ...
    items: [
      { id: "c01", name: "Combo individual", price: 580, img: "/Photos/combo ind.jpeg"  },
      { id: "c02", name: "Combo pareja", price: 990, img: "/Photos/combo pareja.jpeg"  },
      { id: "c03", name: "Combo doble", price: 1280, img: "/Photos/combo doble.jpeg"  },
      { id: "c04", name: "Combo triple", price: 1640, img: "/Photos/combo triple.jpg"  },
    ],
  },
  {
    id: "extras",
    name: "EXTRAS",
    items: [
      { id: "e01", name: "Salsa de soja (1 incluida)", price: 40 },
